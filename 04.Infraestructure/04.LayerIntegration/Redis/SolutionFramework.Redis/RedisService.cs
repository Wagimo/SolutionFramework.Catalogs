...
using SolutionFramework.Redis.Option;
using StackExchange.Redis;
using System.Net.Security;
using System.Security.Cryptography.X509Certificates;
using System.Text.Json;

namespace SolutionFramework.Redis
{
    /// <summary>
    ...
    public class RedisService : IRedisService
    {
        ...
        private void Initialize()
        {
            ...
            {
                //Certificado enviado por el cliente
            ...
            if (this.Connection.IsConnected)
            {
                ...
                this.Database = this.Connection.GetDatabase((int)(configuration.DefaultDatabase ?? 0));
            }
        }
        ...
        {
            this.Connection.ConfigurationChanged += ConfigurationChanged;
            this.Connection.ConfigurationChangedBroadcast += ConfigurationChangedBroadcast;
            this.Connection.ConnectionFailed += ConnectionFailed;
            this.Connection.ConnectionRestored += ConnectionRestored;
            this.Connection.ErrorMessage += ErrorMessage;
            this.Connection.HashSlotMoved += HashSlotMoved;
            this.Connection.InternalError += InternalError;
        }
        ...
        private void ConfigurationChanged(object? sender, EndPointEventArgs args)
        {
            ...
            logger.LogInformation("Configuration Changed - Data: {0}", JsonSerializer.Serialize(data, this.jsonSerializerOptions));
        }
    }
}
